...
if __name__ == "__main__":
    ...
    ######## TEMPORARY ###############
    # input_file_path = "data/replication_time/results/normalized_input/all_input_ctype_%s.csv"%i
    # opportunities = "genome"
    # output_path = "data/replication_time/results/SigNet"%i
    # experiment_id = "ctype_i"
    # plot_figs = False
    # # Read data
    ...
    if unique_abundances == True:
        ...
        input_file_path = "data/replication_time/results/normalized_input/all_input_sample_%s.csv"%i
        # opportunities = "data/case_study_GTeX/abundances/abundances_all_tissues.csv"
        opportunities = "genome"
        output_path = "data/replication_time/results/SigNet"
        experiment_id = "sample_%s"%i
