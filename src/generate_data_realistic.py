...
if __name__ == "__main__":
    ...
    if cosmic_version == 'v3':
        generator_model_path = "../trained_models/exp_not_norm/generator_300"
        ...
        experiment_id = "exp_cleaned_generator_v2"
        signatures = read_signatures("../data/data_v2.xlsx", mutation_type_order="../data/mutation_type_order.xlsx")
    else:
        raise NotImplementedError

    data_folder = "../data/"
    real_labels = data_folder + "real_data/sigprofiler_not_norm_PCAWG.csv"
