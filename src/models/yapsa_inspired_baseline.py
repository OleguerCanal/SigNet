...
if __name__ == "__main__":
    ...
    validation_data_in_file = "/final_sets/val_realistic_input.csv"
    test_data_in_file = "/final_sets/test_realistic_input.csv"
    ...
    validation_data_out_file = "/final_sets/val_realistic_baseline_yapsa.csv"
    test_data_out_file = "/final_sets/test_realistic_baseline_yapsa.csv"
