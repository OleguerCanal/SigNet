...
# plot_distribution(label_batch[:, :-1])


models_path = "../../trained_models/%s/"%experiment_id
finetuner_nobaseline = CombinedFinetuner(low_mum_mut_dir=models_path + "finetuner_not_norm_low",
...
plot_distribution(finetuner_nobaseline_guess)
