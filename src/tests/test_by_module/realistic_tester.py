...
# Load data
data_path = "../../../data/exp_cleaned_generator/"
inputs = csv_to_tensor(data_path + "test_generator_input.csv", device='cpu')
baselines = csv_to_tensor(data_path + "test_generator_baseline.csv", device='cpu')
...
# Make guess
models_path = "../../../trained_models/exp_cleaned_generator/"
...
plot_all_metrics_vs_mutations( list_of_methods, list_of_guesses, labels, '', show=True)
