...
class DataLoader:  #TODO(oleguer): Inherit from torch.utils.data.Dataset
    ...
    def make_random_set(self, set, normalize=True):
        ...
        if set == "train":
            batch_size = 70000
            range_muts = [10000, 50000, 100000]
            # range_muts = [15, 100, 500, 5000, 10000]
            # ind_range_muts = [0]*25000 + [1]*25000 + [2]*15000 + [3]*15000    # The -1 means real distribution
            ind_range_muts = [0]*20000 + [1]*20000 + [-1]*30000    # The -1 means real distribution
        elif set == "val":
            batch_size = 12000
            range_muts = [15, 100, 500, 5000, 50000]
            ind_range_muts = [0]*3000 + [1]*3000 + [2]*2000 + [3]*2000 + [-1]*2000          # The -1 means real distribution
